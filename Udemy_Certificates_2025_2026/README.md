...
- **Python 3: Fundamentals**  
  *Instructor: Dr. Fred Baptiste*  
  Covers core Python programming concepts, syntax, data structures, functions, and foundational software development practices.
...
- **The Git & GitHub Bootcamp**  
  *Instructor: Colt Steele*  
  Professional Git workflows, branching strategies, collaboration practices, pull requests, and repository management with GitHub.
